...
\caption{The three stilbene isomers. Reproduced from Ref.~\cite{10.1021/acs.jctc.4c01008} under \href{https://creativecommons.org/licenses/by/4.0}{CC BY 4.0}.}
...
\caption{Simulated \gls{trpes} for surface hopping dynamics with various electronic structure methods. Reproduced from Ref.~\cite{10.1021/acs.jctc.4c01008} under \href{https://creativecommons.org/licenses/by/4.0}{CC BY 4.0}.}
...
\caption{Quantum yields of \textit{cis}-stilbene photoproducts as a function of applied force constant. The upper panel shows the product ratio as a function of the force constant $k$ of the harmonic oscillator, as referenced in the paragraph above. The lower panel shows the energy difference between the \gls{fc} point (dashed line) and several \glspl{ci}, also varying with different values of $k$. Reproduced from Ref.~\cite{10.1021/acs.jctc.4c01008} under \href{https://creativecommons.org/licenses/by/4.0}{CC BY 4.0}.}
