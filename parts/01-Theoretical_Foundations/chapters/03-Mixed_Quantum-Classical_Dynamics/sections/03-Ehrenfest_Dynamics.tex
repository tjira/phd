...
When the \acrshort{boa} fails, the nuclear and electronic degrees of freedom become coupled, and the dynamics of the system can no longer be described by a single potential energy surface. In this case, one needs to consider the full quantum dynamics of the system, which is usually computationally expensive. The Ehrenfest dynamics is one of the first mixed quantum-classical methods developed to describe the coupled dynamics of electrons and nuclei.
