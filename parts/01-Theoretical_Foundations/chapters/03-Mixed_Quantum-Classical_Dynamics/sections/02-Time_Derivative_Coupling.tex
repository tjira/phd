...
\end{equation}
The \acrshort{tdc} $\sigma_{IJ}=\Braket{\phi_I\vert\frac{\partial \phi_J}{\partial t}}$ at a time $t+\frac{\Delta t}{2}$ is then formed as an overlap between the expressions in Eq.~\eqref{eq:hst_wfn} and Eq.~\eqref{eq:hst_dwfn}:
