...
\centering
\includegraphics[width=.9\linewidth]{\filedirpath/images/lz_contour_counterclockwise}
\end{subfigure}\begin{subfigure}{.5\textwidth}
\centering
\includegraphics[width=.9\linewidth]{\filedirpath/images/lz_contour_clockwise}
\end{subfigure}
