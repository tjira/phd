\section{\filetotitle}\label{sec:spectral_theory_in_hilbert_spaces}
...
transformations and the time evolution of isolated systems. If $\mathcal{H}$ is finite-dimensional, the spectral structure is simple.
...
In infinite-dimensional Hilbert spaces, self-adjoint operators may have both discrete and continuous parts of the spectrum. The finite sum in the previous subsection is replaced by a combination of sums and integrals. Heuristically, one can write the spectral decomposition of a self-adjoint operator $A$ as
...
\end{equation}
which is again an heuristic form. The most important example in quantum mechanics is the time-evolution operator generated by a Hamiltonian $H$. For a time-independent Hamiltonian, the unitary time-evolution operator is
\begin{equation}
U(t)=e^{-i t H},
\end{equation}
