...
In infinite-dimensional Hilbert spaces, self-adjoint operators may have both discrete and continuous parts of the spectrum. The finite sum in the previous subsection is replaced by a combination of sums and integrals. Heuristically, one can write the spectral decomposition of a self-adjoint operator $A$ as\cite{1021172445}
