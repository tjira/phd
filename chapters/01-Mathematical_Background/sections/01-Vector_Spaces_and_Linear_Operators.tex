...
\end{equation}
We now get to the concept of eigenvalues and eigenvectors, which lay at the heart of quantum mechanics, as they correspond to measurable quantities and their associated states. Every observable in quantum mechanics is represented by a linear operator, and the possible measurement outcomes are given by its eigenvalues.
