...
The first variational principle we consider is the \acrfull{dfvp}.\supercite{10.1017/S0305004100016108,1477741} The exact time evolution for our parametrized wavefunction $\ket{\Psi(\symbf{\alpha})}$ is governed by the \acrshort{tdse}
\begin{equation}
