...
\mathcal{L}(\symbf{\alpha},\symbf{\alpha}^\ast)=\Braket{\Psi(\symbf{\alpha})|i\ddt-H|\Psi(\symbf{\alpha})}.
\end{equation}
...
\subsection{Equality of Variational Principles}\label{sec:equality_of_variational_principles}
