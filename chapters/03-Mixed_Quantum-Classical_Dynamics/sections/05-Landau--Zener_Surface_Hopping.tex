...
\begin{equation}
\ket{\Psi(t)}=Ae^{-i\int^tE_1\symrm{d}t}\ket{\tilde{\phi}_1}+Be^{-i\int^tE_2\symrm{d}t}\ket{\tilde{\phi}_2},
\end{equation}
...
\begin{equation}
\int_{-\infty}^\infty\frac{1}{t}\frac{\ddot B}{B}\symrm{d}t=\pm2\pi i\,\symrm{Res}\left(\frac{1}{t}\frac{\ddot B}{B},0\right)\delta=\pm2\pi i\frac{\ddot B(0)}{B(0)}\delta=\mp2\pi i\frac{g^2}{4}\delta,
\end{equation}
